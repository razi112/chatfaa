...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ChatSphere — Username-based real-time messaging" },
      { name: "description", content: "Private, real-time chat with usernames instead of phone numbers. Fast, anonymous, beautifully dark." },
      { property: "og:title", content: "ChatSphere" },
      { property: "og:description", content: "Private, real-time messaging with usernames — no phone number required." },
